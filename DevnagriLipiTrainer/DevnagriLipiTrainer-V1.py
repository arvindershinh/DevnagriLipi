...
#        w=tf.Variable(tf.truncated_normal([5, 5, In, Out], stddev=0.1), dtype=tf.float32, name='w')
#        b=tf.Variable(tf.constant(0.1, shape=[Out]), dtype=tf.float32, name='b')
...
def dense_layer(inputs, In, Out, name='Dense'):
    with tf.name_scope(name):
        ...
        b=tf.Variable(tf.zeros((Out)), dtype=tf.float32, name='b')
#        w=tf.Variable(tf.truncated_normal([In, Out], stddev=0.1), dtype=tf.float32, name='w')
#        b=tf.Variable(tf.constant(0.1, shape=[Out]), dtype=tf.float32, name='b')
